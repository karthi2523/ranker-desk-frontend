...
export function PdfSecureViewer({ pdfUrl, title }: PdfSecureViewerProps) {
 ...
 {/* ── Controls toolbar ────────────────────────────────── */}
 <div className="flex items-center justify-between px-4 py-2 bg-surface border-b border-border shrink-0 select-none z-10">
 ...
 <span className="text-xs font-mono text-text-secondary px-2 min-w-[80px] text-center tabular-nums">
 {pageNumber} / {numPages ||"—"}
 </span>
 <Button
 variant="ghost"
 ...
 variant="ghost"
 size="icon"
 className="h-7 w-7 text-text-secondary hover:text-text-primary p-0"
 onClick={zoomOut}
 title="Zoom out"
 >
 ...
 variant="ghost"
 size="icon"
 className="h-7 w-7 text-text-muted hover:text-text-primary p-0 ml-0.5"
 onClick={resetZoom}
 title="Reset zoom"
 >
 ...
 */}
 <div
 ref={containerRef}
 className="pdf-viewer-area flex-1 overflow-y-auto overflow-x-auto flex flex-col items-center gap-4 py-6 bg-surface-raised/30"
